 ...
 * @author Sami Koivu
 */
public class _dcmpl extends Instruction {
	...
	public List<StackElement> getPoppedElements(DecompilationContext dc) {
		...
		elements.add(new StackElement("value1", StackElementType.DOUBLE));
		elements.add(new StackElement("value2", StackElementType.DOUBLE));
		return elements;
	}

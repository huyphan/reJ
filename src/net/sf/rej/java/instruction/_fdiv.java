 ...
 * @author Sami Koivu
 */
public class _fdiv extends Instruction {

	public static final int OPCODE = 0x6e; // error in spec(instructions by
											// opcode)
	...
	public List<StackElement> getPoppedElements(DecompilationContext dc) {
		...
		elements.add(new StackElement("value1", StackElementType.FLOAT));
		elements.add(new StackElement("value2", StackElementType.FLOAT));
		return elements;
	}

 ...
 * @author Sami Koivu
 */
public class _invokeinterface extends Instruction {
	...
	public Parameters getParameterTypes() {
		return new Parameters(new ParameterType[] {
				ParameterType.TYPE_CONSTANT_POOL_METHOD_REF,
